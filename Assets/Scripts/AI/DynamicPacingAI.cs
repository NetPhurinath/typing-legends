...
public class DynamicPacingAI : MonoBehaviour
{
 ...
 // ถ้าพลาดติดกัน1 ครั้ง ให้เข้า Recovery ทันที
 if (consecutiveMistakes >=1)
 {
 newState = PacingState.Recovery;
 }
 // ถ้าทำดีติดกัน3 ครั้งขึ้นไป ให้เข้า Burst
 else if (consecutiveGoodWords >= burstRequiredStreak)
 {
 newState = PacingState.Burst;
 consecutiveGoodWords =0;
 }
 // ถ้าผู้เล่นทำได้ดีติดกัน2 ครั้ง หรือทำงานเร็วแม่นยำตามเกณฑ์ ให้เข้า Pressure
 ...
 {
 // ผิดมากกว่า1 ครั้ง นับเป็นการพลาด
 consecutiveMistakes++;
 consecutiveGoodWords =0;
 }
